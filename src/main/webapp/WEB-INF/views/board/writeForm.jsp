...
<body onload="writeFocus()">
	<h2>글쓰기</h2>
	<form name="writeform" action="writePro" method="post" onsubmit="return writeCheck()">
		...
		<table>
			<tr>
				<th>작성자</th>
				<td>
					<input class="input" type="text" name="writer" maxlength="20" style="float:left; width:110px;">
				</td>
				<tr>
					<th>비밀번호</th>
					<td>
				...
				<tr>
					<th colspan="2">
						...
						<input class="inputButton" type="button" value="목록" formaction="list" onclick="history.back();">
					</th>
				</tr>
		</table>
	</form>
